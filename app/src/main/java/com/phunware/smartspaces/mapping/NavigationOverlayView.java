...
public class NavigationOverlayView extends ViewPager implements Navigator.OnManeuverChangedListener {
    ...
    private static final class ManeuverPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            //Log.d("EXPLORE","STRAIGHT PATH... = "+displayHelper.stringForDirection(context, m.mainManeuver));
            ...
            if (m.turnManeuver == null) {
                ...
                //networkManager.sendDirectionsRequestToJoan("display-3","user@phunjoan.com","left");

                Log.d("EXPLORE","TURNS... = "+displayHelper.stringForDirection(context, m.turnManeuver));

                String turn = displayHelper.stringForDirection(context, m.turnManeuver);


                String[] tokens = turn.split(" ");
                String directionForJoan = tokens[1];



                handler.postDelayed(() -> {
                    networkManager.sendDirectionsRequestToJoan(
                            "display-2",
                            "user@phunjoan.com",directionForJoan );
